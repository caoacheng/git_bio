...
with open("Methylation Beta Value0.2.0.txt",'r') as f:
    m=0
...
if __name__ == '__main__':
    ...
    with open("Methylation Beta Value0.2.0.txt",'r') as f:
         for line in f.readlines():
             ...
             value12.append(data)
    file12=[]
    with open("biaohao_new1.txt",'r') as f1:
         for lines in f1.readlines():
             lines=lines.strip('\n')
             datas=lines.split('\t')
             file12.append(datas)
    myList[0][:-2]=value12[0]
    myList[0][-2]=file12[0][5]
    myList[0][-1]=file12[0][8]
    del value12[0]
    del file12[0]
    for x in value12:
        for xx in file12:
    ...
    data.to_csv("Methylation Beta Value0.2.1.txt",sep='\t',header=True,index=True)
