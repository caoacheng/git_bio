...
if __name__ == '__main__':
    ...
    print "正在读取数据。。。。"
    data_new=pd.read_csv("Methylation Beta Value1.6.txt",sep='\t',index_col=0)
    data= data_new.T
    gene= oneway_deal(data)
    print len(gene)-1
    
    ma=[]
    with open("Methylation Beta Value1.6.txt",'r') as f:
    ...
    filename='Methylation Beta Value1.7.txt'
